...
class dilatedUAFM_SpAtten(UAFM):
    """
    ...
    def __init__(self, x_ch, y_ch, out_ch, ksize=3, resize_mode='bilinear'):
        ...
        dilation_rate = 2  # You can adjust this value based on your needs

        self.conv_xy_atten = nn.Sequential(
            layers.ConvBNReLU(
                4, 2, kernel_size=3, padding=dilation_rate, dilation=dilation_rate, bias_attr=False),
            layers.ConvBN(
                2, 1, kernel_size=3, padding=dilation_rate, dilation=dilation_rate, bias_attr=False))
